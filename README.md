# GrandContentHub — Умный реестр контента в MWS Tables
Проект, созданный в рамках хакатона.  
GrandContentHub — это веб-приложение для анализа эффективности контента с использованием данных из MWS Tables и возможностей LLM.
